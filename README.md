...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/speedcopy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12428&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/speedcopy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `speedcopy` can be installed with:

```
conda install speedcopy
```

It is possible to list all of the versions of `speedcopy` available on your platform with:
